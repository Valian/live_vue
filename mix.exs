defmodule LiveVue.MixProject do
  ...
  defp aliases do
    [
      ...
      "release.patch": ["assets.build", "expublish.patch --branch=main"],
      "release.minor": ["assets.build", "expublish.minor --branch=main"],
      "release.major": ["assets.build", "expublish.major --branch=main"]
    ]
  end
end
