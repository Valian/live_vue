...
config :live_vue_examples, LiveVueExamplesWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "8y+qPI5zMKa5nmBhiv97NvlS+0biQZxYFwwGFQnQmpWIN2BQMR46axuppXIzJxUr",
...
config :live_vue_examples, LiveVueExamplesWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ~r"priv/gettext/.*(po)$",
      ~r"lib/live_vue_examples_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
