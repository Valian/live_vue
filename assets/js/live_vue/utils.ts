 ...
 */
export const mapValues = <T, U>(object: Record<string, T>, cb: (value: T, key: string, object: Record<string, T>) => U): Record<string, U> =>
 ...
 */
export const flatMapKeys = <T>(object: Record<string, T>, cb: (key: string, value: any, object: Record<string, T>) => string[]): Record<string, T> =>
  Object.entries(object).reduce((acc, [key, value]) => {
